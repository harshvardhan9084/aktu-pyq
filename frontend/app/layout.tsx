...
export const metadata: Metadata = {
  ...
  description:
    'Semantic search over AKTU previous-year question papers. Find the most repeated questions by subject, unit, and type in seconds.',
  ...
  return (
    ...
    >
      <body className="relative">
        <ThemeProvider>
          {/* Background orbs — themed via CSS vars */}
          ...
          {/* Analytics initialiser (client component, no UI) */}
          <AnalyticsInit />
